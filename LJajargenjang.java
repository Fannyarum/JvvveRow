 ...
 * @author ACER
 */
public class LJajargenjang extends javax.swing.JFrame {

    /**
     * Creates new form LJajargenjang
     */
    public LJajargenjang() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LUAS JAJAR GENJANG");
    ...
    double alas = Double.parseDouble(Txt1.getText());
    double tinggi = Double.parseDouble(Txt2.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LJajargenjang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LJajargenjang().setVisible(true);
            }
        });
    }
